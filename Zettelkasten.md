...
All notes in a Zettelkasten are linear, [atomic and autonomous](https://neuron.zettel.page/atomic.html), with links created between them, enabling a [heterarchy](https://neuron.zettel.page/heterarchy.html) to evolve organically, rather than having to preconceive a hierarchy ahead (as is the case with outliners like Workflowy and Dynalist).
