...
- **Chemicals**:
	...
	- Arsenic -> SCC of skin, lung cancer **(smoking)**
		- Woman in england applied Arsenic onto the skin to prevent tan coz they secretly had orgy parties in the sun. Yes. (no they worked in fields lol. maybe they didn't)4
	...
	- Nitrosamines -> Intestinal Stomach Carcinoma -
		- Waifus in japan eat smoked meat ( ͡❛ ͜ʖ ͡❛) then get stomach cancer. sed. [^insensitive]
...
1. ***Growth Factors***
	* PDGF usually divides the astrocyte
		- Mutation leads to astrocyte production of PDGFB (==autocrine==)
		- This autocrine overexpression leads to a loop of overgrowth -> **Astrocytoma**
2. ***Growth Factor Receptors***
	...
	* **ERBB2** [HER2/neu] -> amplified in **subset** of ==breast cancer==
	...
	- **RET** -> medullary carcinoma of thyroid: associated with MEN2A MEN2B
		- MEN2A and 2B are Medullary Endocrine Neoplasi, a syndrome in which tumors are developed in endocrine organs
...
4. ***Nuclear Regulators***
	...
	- **c**-MYC
		- Burkitt Lymphoma
			...
			-  This translocation leads to excess producion of c-MYC leading to high growth of cells
...
* p53 "verifies" DNA integrity before it enter S phase
	...
	* If DNA repair is not possible, *(such as too many high fucks inside the car wayyy too much cocaine broo)* due to excess mutations, then p53 nukes the entire cell via apoptosis
		...
		<iframe src="https://open.spotify.com/embed/track/2udGjDmpK1dH9VGyw7nrei?theme=0" width="100%" height="380" frameBorder="0" allowtransparency="true" allow="encrypted-media"></iframe>
	...
	* **Both** copies of p53 must be knocked out - ==Knudson two-hit hypothesis== *cops take cocaine rip corrupt crack addicts*
		...
		* Germline mutation results in knock out of one copy of p53 (1 corrupt fucker) - in ==Li-Fraumeni syndrome a==nd the second hit is ==somatic==
...
* G1 -> S 
	 ...
	 * However Retinoblastoma is that old-ass overprotective parent who needs some phosphorylation (dowry) for release of E2F
		 * Guess the dowry? Oh yeah Cyclin D/CDK4 Complex
